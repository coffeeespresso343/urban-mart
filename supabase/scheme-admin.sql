...
-- Adds an avatar_url column and a per-user-folder-scoped Storage bucket
-- for the admin's own profile photo — scoped by folder (avatars/{user_id}/...),
-- not by admin role, since this is a self-service "my own account" feature.
