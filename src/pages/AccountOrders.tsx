...
const AccountOrders = () => {
  ...
  return (
    <div className="container-edge py-10 sm:py-14">
      <h1 className="font-display flex items-center gap-2 text-2xl font-black text-ink sm:text-3xl">
      ...
      {orders === null ? (
        ...
        <div className="mt-10 flex flex-col  border-y border-line-light">
          <div className="divide-y divide-line-light">
            {orders.map((order) => (
              <div key={order.id} className="relative">
                <span className="absolute right-0 top-2 text-stone opacity-80">
                ...
                >
                  ...
                  <span className="price text-xs font-semibold">
